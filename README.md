...
Aqui estão os principais projetos desenvolvidos por mim durante a graduação:

* **🏆 [Robô Seguidor de Linha (1º Lugar)](https://github.com/ViniciusBonvin/Robo-Seguidor-Linha):** Projeto campeão de engenharia autônoma desenvolvido com Arduino, motores e sensores infravermelhos. Contém a documentação completa e o vídeo do robô em funcionamento.
* **🐍 [Exercícios e Projetos em Python](https://github.com/ViniciusBonvin/projetos_Python-):** Repositório focado no aprendizado da linguagem Python, lógica de programação e resolução de algoritmos.
